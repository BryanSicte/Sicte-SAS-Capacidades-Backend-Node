...
router.post('/crearRegistro', validarToken, async (req, res) => {
    ...
    try {
        ...
        const requiredFields = {
            ...
            compensacionTiemposServiciosMes: "Ingrese la compensación por tiempo de servicios meses.",
            compensacionTiemposServiciosDias: "Ingrese la compensación por tiempo de servicios dias.",
            compensacionTiemposServicios: "Ingrese la compensación por tiempos de servicios.",
            mesesPendientesVacaciones: "Ingrese los meses pendientes de vacaciones.",
            diasPendientesVacaciones: "Ingrese los días pendientes de vacaciones.",
            valorVacacionesTruncasMeses: "Ingrese el valor de vacaciones truncas meses.",
            valorVacacionesTruncasDias: "Ingrese el valor de vacaciones truncas dias.",
            ...
            valorCotizacionPensiones: "Ingrese el valor de cotizacion de pensiones.",
            ...
            otrosDescuentos: "Ingrese otros descuentos.",
            otrosPagos: "Ingrese otros pagos.",
